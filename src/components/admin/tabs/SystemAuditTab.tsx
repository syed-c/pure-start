  ...
  const { data: stats, isLoading: statsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        fosterCarers: fosterCarersCount || 0,
  ...
  const existingModules: SystemModule[] = [
    {
      ...
      status: 'active',
      description: 'Supabase Auth with role-based access (super_admin, foster_carer, applicant, trainer)',
    ...
    },
    {
      ...
      status: 'active',
      description: 'Fostering agency profiles with Ofsted status, claim flow, locations',
      tables: ['agencies', 'agency_locations', 'agency_hours', 'agency_images'],
