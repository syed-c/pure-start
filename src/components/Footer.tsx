...
import { 
  ...
  Mail, Phone, MapPin, Heart, ChevronRight, Shield, CheckCircle, Lock, MessageSquare,
} from "lucide-react";
...
export const Footer = forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ...
  const contactWhatsApp = siteSettings?.contactDetails?.whatsapp || '';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <div className="space-y-2 mb-4">
              ...
              {contactWhatsApp && (
                <a href={`https://wa.me/${contactWhatsApp.replace(/[^\d]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-background/50 hover:text-primary transition-colors">
