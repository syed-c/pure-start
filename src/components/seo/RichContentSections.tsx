  ...
  return [
    {
      ...
      body: `${serviceName} is a vital part of the UK's children's social care system, designed to provide nurturing family-based care for children and young people who cannot safely remain with their birth families. Unlike residential care, ${sn} places children within trained family households, giving them the stability, routine, and individual attention they need to thrive. Across England, Scotland, Wales, and Northern Ireland, ${agencyCount > 0 ? agencyCount + '+' : 'hundreds of'} agencies recruit, train, and support carers who specialise in ${sn}. The approach is grounded in attachment theory and trauma-informed practice, ensuring that carers understand the impact of early adversity and can respond with patience, empathy, and skill. Whether you are exploring fostering for the first time or looking to transfer to an agency that better supports ${sn}, Foster Connect's directory helps you compare options, read Ofsted reports, and make an informed choice.`,
    },
    {
      icon: Users,
