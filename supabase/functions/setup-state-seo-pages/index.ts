...
const STATIC_PAGES = [
  { slug: "/", page_type: "static", title: "Foster Care – UK Fostering Agency Directory", h1: "Find Trusted Fostering Agencies Near You", meta_title: "Foster Care | UK Fostering Agency Directory", meta_description: "Compare Ofsted-rated fostering agencies across the UK. Read carer reviews, check ratings, and start your fostering journey with Foster Care." },
  { slug: "about", page_type: "static", title: "About Foster Care", h1: "About Foster Care", meta_title: "About Us | Foster Care", meta_description: "Learn about Foster Care's mission to help prospective foster carers find the right agency across England, Scotland, Wales, and Northern Ireland." },
  { slug: "contact", page_type: "static", title: "Contact Foster Care", h1: "Contact Us", meta_title: "Contact Us | Foster Care", meta_description: "Get in touch with the Foster Care team. We're here to help you find the right fostering agency." },
  { slug: "faq", page_type: "static", title: "Frequently Asked Questions", h1: "Fostering FAQ", meta_title: "Fostering FAQ | Foster Care", meta_description: "Answers to common questions about fostering in the UK, from eligibility to allowances and the assessment process." },
  { slug: "how-it-works", page_type: "static", title: "How Foster Care Works", h1: "How It Works", meta_title: "How It Works | Foster Care", meta_description: "Discover how Foster Care helps you compare fostering agencies, read reviews, and start your fostering journey." },
  { slug: "blog", page_type: "blog", title: "Fostering Blog", h1: "Foster Care Blog", meta_title: "Fostering Blog | Foster Care", meta_description: "Expert articles, carer stories, and guidance on fostering in the UK." },
  { slug: "privacy", page_type: "static", title: "Privacy Policy", h1: "Privacy Policy", meta_title: "Privacy Policy | Foster Care", meta_description: "Foster Care privacy policy – how we handle your data." },
  { slug: "terms", page_type: "static", title: "Terms of Service", h1: "Terms of Service", meta_title: "Terms of Service | Foster Care", meta_description: "Foster Care terms of service for users and agencies." },
  { slug: "pricing", page_type: "static", title: "Pricing for Agencies", h1: "Agency Pricing Plans", meta_title: "Pricing | Foster Care", meta_description: "View Foster Care pricing plans for fostering agencies looking to increase visibility and attract carers." },
  { slug: "services", page_type: "static", title: "Fostering Services", h1: "Fostering Services & Types", meta_title: "Fostering Types & Services | Foster Care", meta_description: "Explore different types of fostering including emergency, respite, therapeutic, long-term, and short-term fostering across the UK." },
];
  ...
  for (const state of states || []) {
    try {
      const { error } = await supabaseAdmin.from("seo_pages").upsert({
        ...
        meta_title: `Fostering Agencies in ${state.name} | Foster Care`,
        meta_description: `Find Ofsted-rated fostering agencies in ${state.name}. Compare agencies, read carer reviews, and start your fostering journey with Foster Care.`,
  ...
  for (const t of treatments || []) {
    try {
      const { error } = await supabaseAdmin.from("seo_pages").upsert({
        ...
        h1: t.name,
        meta_title: `${t.name} | Foster Care`,
        meta_description: `Learn about ${t.name.toLowerCase()} across the UK. Find specialised agencies, understand the process, and explore your options with Foster Care.`,
  ...
  for (const city of cities || []) {
    ...
    try {
      const { error } = await supabaseAdmin.from("seo_pages").upsert({
        ...
        meta_title: `Find Fostering Agencies in ${city.name} | Foster Care`,
    ...
    for (const t of treatments || []) {
      ...
      try {
        const { error } = await supabaseAdmin.from("seo_pages").upsert({
          ...
          meta_title: `${t.name} in ${city.name} | Foster Care`,
  ...
  for (const t of treatments || []) {
    try {
      const { error } = await supabaseAdmin.from("seo_pages").upsert({
        ...
        h1: t.name,
        meta_title: `${t.name} | Foster Care`,
        meta_description: `Learn about ${t.name.toLowerCase()} across the UK. Find specialised agencies with Foster Care.`,
        canonical_url: `/services/${t.slug}`,
        is_indexed: true, is_thin_content: true, needs_optimization: true,
        updated_at: new Date().toISOString(),
      }, { onConflict: "slug" });
